...
const WC_2026_TEAMS = [
  ...
  "Colômbia", "Croácia", "Dinamarca", "Egito", "Equador", "Espanha",
  "Estados Unidos", "França", "Holanda", "Hungria", "Irã", "Japão",
  "Marrocos", "México", "Nigéria", "Nova Zelândia", "Palestina", "Peru",
  "Polônia", "Portugal", "Qatar", "Romênia", "Senegal", "Sérvia",
